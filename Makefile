...
IMG ?= europe-north1-docker.pkg.dev/nais-io/nais/images/pgrator:latest
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	- $(CONTAINER_TOOL) buildx create --name pgrator-builder
	$(CONTAINER_TOOL) buildx use pgrator-builder
	- $(CONTAINER_TOOL) buildx build --load --platform=$(PLATFORMS) --tag ${IMG} .
	- $(CONTAINER_TOOL) buildx rm pgrator-builder
