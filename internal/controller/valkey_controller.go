...
import (
	...
	valkey "github.com/nais/pgrator/internal/resourcecreator/valkey"
...
func (r *ValkeyReconciler) Update(obj *v1.Valkey, _ ValkeyPreparedData, _ reconciler.RelatedObjects) ([]action.Action, ctrl.Result, error) {
	...
	aivenValkey, err := valkey.CreateSpec(r.Scheme, obj, r.Aiven, r.Tenant)
	if err != nil {
	...
	serviceIntegration, err := valkey.CreateServiceIntegrationSpec(r.Scheme, obj, r.Aiven)
	if err != nil {
...
func (r *ValkeyReconciler) Delete(obj *v1.Valkey, _ ValkeyPreparedData, relatedObjects reconciler.RelatedObjects) ([]action.Action, ctrl.Result, error) {
	...
	aivenValkey := valkey.Minimal(obj)
	...
	serviceIntegration := valkey.MinimalServiceIntegration(obj)
	actions := []action.Action{
